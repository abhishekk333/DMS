...
function() {
    ...
    angular.module("ui.tree").controller("TreeNodeController", ["$scope", "$element", function(e, n) {
        ...
        this.scope = e, e.$element = n, e.$modelValue = null, e.$parentNodeScope = null, e.$childNodesScope = null, e.$parentNodesScope = null, e.$treeScope = null, e.$handleScope = null, e.$type = "uiTreeNode", e.$$allowNodeDrop = !1, e.collapsed = !1, e.init = function(t) {
            var o = t[0];
    ...
    angular.module("ui.tree").directive("uiTree", ["treeConfig", "$window", function(e, n) {
        return {
            ...
            link: function(t, o, l, r) {
                ...
                }), c.accept = function(e, n) {
                    return !(n.nodropEnabled || n.$treeScope.nodropEnabled || n.outOfDepth(e))
                }, c.beforeDrag = function() {
                    return !0
                }, c.removed = function() {}, c.dropped = function() {}, c.dragStart = function() {}, c.dragMove = function() {}, c.dragStop = function() {}, c.beforeDrop = function() {}, c.toggle = function() {}, t.$watch(l.uiTree, function(e) {
    ...
    angular.module("ui.tree").directive("uiTreeNode", ["treeConfig", "UiTreeHelper", "$window", "$document", "$timeout", "$q", function(e, n, t, o, l, r) {
        return {
            ...
            link: function(a, i, d, c) {
                var s, u, p, f, m, h, g, $, b, N, y, v, S, E, T, x, C, w, D, X, Y, A, V, H, I = {},
                    O = "ontouchstart" in window,
                    k = null,
                    M = document.body,
                    P = document.documentElement;
                angular.extend(I, e), I.nodeClass && i.addClass(I.nodeClass), a.init(c), a.collapsed = !!n.getNodeAttribute(a, "collapsed") || e.defaultCollapsed, a.sourceOnly = a.nodropEnabled || a.$treeScope.nodropEnabled, a.$watch(d.collapsed, function(e) {
                    ...
                    if ((O || 2 !== e.button && 3 !== e.which) && !(e.uiTreeDragging || e.originalEvent && e.originalEvent.uiTreeDragging)) {
                        var l, r, d, c, N, y, v, S, E, T = angular.element(e.target);
                        if (l = n.treeNodeHandlerContainerOfElement(T), l && (T = angular.element(l)), r = i.clone(), S = n.elementIsTreeNode(T), E = n.elementIsTreeNodeHandle(T), (S || E) && !(S && n.elementContainsTreeNodeHandler(T) || (d = T.prop("tagName").toLowerCase(), "input" == d || "textarea" == d || "button" == d || "select" == d))) {
                            for (H = angular.element(e.target); H && H[0] && H[0] !== i;) {
                                if (n.nodrag(H)) return;
                                H = H.parent()
                            }
                            a.beforeDrag(a) && (e.uiTreeDragging = !0, e.originalEvent && (e.originalEvent.uiTreeDragging = !0), e.preventDefault(), N = n.eventObj(e), s = !0, u = n.dragInfo(a), c = i.prop("tagName"), "tr" === c.toLowerCase() ? (f = angular.element(t.document.createElement(c)), y = angular.element(t.document.createElement("td")).addClass(I.placeholderClass).attr("colspan", i[0].children.length), f.append(y)) : f = angular.element(t.document.createElement(c)).addClass(I.placeholderClass), m = angular.element(t.document.createElement(c)), I.hiddenClass && m.addClass(I.hiddenClass), p = n.positionStarted(N, i), f.css("height", n.height(i) + "px"), h = angular.element(t.document.createElement(a.$parentNodesScope.$element.prop("tagName"))).addClass(a.$parentNodesScope.$element.attr("class")).addClass(I.dragClass), h.css("width", n.width(i) + "px"), h.css("z-index", 9999), v = (i[0].querySelector(".angular-ui-tree-handle") || i[0]).currentStyle, v && (document.body.setAttribute("ui-tree-cursor", o.find("body").css("cursor") || ""), o.find("body").css({
                                cursor: v.cursor + "!important"
                            })), a.sourceOnly && f.css("display", "none"), i.after(f), i.after(m), h.append(u.isClone() && a.sourceOnly ? r : i), o.find("body").append(h), h.css({
                                left: N.pageX - p.offsetX + "px",
                                top: N.pageY - p.offsetY + "px"
                            }), g = {
                                placeholder: f,
                                dragging: h
                            }, D(), a.$apply(function() {
                                a.$treeScope.$callbacks.dragStart(u.eventArgs(g, p))
                            }), $ = Math.max(M.scrollHeight, M.offsetHeight, P.clientHeight, P.scrollHeight, P.offsetHeight), b = Math.max(M.scrollWidth, M.offsetWidth, P.clientWidth, P.scrollWidth, P.offsetWidth))
                        }
                    }
                }, y = function(e) {
                    var o, l, r, i, d, c, m, N, y, v, S, E, T, x, C, w, D, X = n.eventObj(e);
                    if (h) {
                        if (e.preventDefault(), t.getSelection ? t.getSelection().removeAllRanges() : t.document.selection && t.document.selection.empty(), r = X.pageX - p.offsetX, i = X.pageY - p.offsetY, 0 > r && (r = 0), 0 > i && (i = 0), i + 10 > $ && (i = $ - 10), r + 10 > b && (r = b - 10), h.css({
                                left: r + "px",
                                top: i + "px"
                            }), d = window.pageYOffset || t.document.documentElement.scrollTop, c = d + (window.innerHeight || t.document.clientHeight || t.document.clientHeight), c < X.pageY && $ > c && (C = Math.min($ - c, 10), window.scrollBy(0, C)), d > X.pageY && window.scrollBy(0, -10), n.positionMoved(e, p, s), s) return void(s = !1);
                        if (N = n.offset(h).left - n.offset(f).left >= I.threshold, y = X.pageX - (t.pageXOffset || t.document.body.scrollLeft || t.document.documentElement.scrollLeft) - (t.document.documentElement.clientLeft || 0), v = X.pageY - (t.pageYOffset || t.document.body.scrollTop || t.document.documentElement.scrollTop) - (t.document.documentElement.clientTop || 0), angular.isFunction(h.hide) ? h.hide() : (S = h[0].style.display, h[0].style.display = "none"), t.document.elementFromPoint(y, v), T = angular.element(t.document.elementFromPoint(y, v)), V = n.treeNodeHandlerContainerOfElement(T), V && (T = angular.element(V)), angular.isFunction(h.show) ? h.show() : h[0].style.display = S, A = !(n.elementIsTreeNodeHandle(T) || n.elementIsTreeNode(T) || n.elementIsTreeNodes(T) || n.elementIsTree(T) || n.elementIsPlaceholder(T)), A && (f.remove(), k && (k.resetEmptyElement(), k = null)), p.dirAx && p.distAxX >= I.levelThreshold && (p.distAxX = 0, p.distX > 0 && (o = u.prev(), o && !o.collapsed && o.accept(a, o.childNodesCount()) && (o.$childNodesScope.$element.append(f), u.moveTo(o.$childNodesScope, o.childNodes(), o.childNodesCount()))), p.distX < 0 && (l = u.next(), l || (m = u.parentNode(), m && m.$parentNodesScope.accept(a, m.index() + 1) && (m.$element.after(f), u.moveTo(m.$parentNodesScope, m.siblings(), m.index() + 1))))), !p.dirAx) {
                            if (n.elementIsTree(T) ? E = T.controller("uiTree").scope : n.elementIsTreeNodeHandle(T) ? E = T.controller("uiTreeHandle").scope : n.elementIsTreeNode(T) ? E = T.controller("uiTreeNode").scope : n.elementIsTreeNodes(T) ? E = T.controller("uiTreeNodes").scope : n.elementIsPlaceholder(T) ? E = T.controller("uiTreeNodes").scope : T.controller("uiTreeNode") && (E = T.controller("uiTreeNode").scope), x = !1, !E) return;
                            if (!E.$treeScope || E.$parent.nodropEnabled || E.$treeScope.nodropEnabled || f.css("display", ""), "uiTree" == E.$type && E.dragEnabled && (x = E.isEmpty()), "uiTreeHandle" == E.$type && (E = E.$nodeScope), "uiTreeNode" != E.$type && !x) return;
                            k && f.parent()[0] != k.$element[0] && (k.resetEmptyElement(), k = null), x ? (k = E, E.$nodesScope.accept(a, 0) && (E.place(f), u.moveTo(E.$nodesScope, E.$nodesScope.childNodes(), 0))) : E.dragEnabled() && (T = E.$element, w = n.offset(T), D = E.horizontal ? X.pageX < w.left + n.width(T) / 2 : X.pageY < w.top + n.height(T) / 2, E.$parentNodesScope.accept(a, E.index()) ? D ? (T[0].parentNode.insertBefore(f[0], T[0]), u.moveTo(E.$parentNodesScope, E.siblings(), E.index())) : (T.after(f), u.moveTo(E.$parentNodesScope, E.siblings(), E.index() + 1)) : !D && E.accept(a, E.childNodesCount()) ? (E.$childNodesScope.$element.append(f), u.moveTo(E.$childNodesScope, E.childNodes(), E.childNodesCount())) : A = !0)
                        }
                        a.$apply(function() {
                            a.$treeScope.$callbacks.dragMove(u.eventArgs(g, p))
                        })
                    }
                }, v = function(e) {
                    var n = u.eventArgs(g, p);
                    e.preventDefault(), X(), a.$treeScope.$apply(function() {
                        r.when(a.$treeScope.$callbacks.beforeDrop(n)).then(function(e) {
                            e !== !1 && a.$$allowNodeDrop && !A ? (u.apply(), a.$treeScope.$callbacks.dropped(n)) : w()
                        })["catch"](function() {
                            w()
                        })["finally"](function() {
                            m.replaceWith(a.$element), f.remove(), h && (h.remove(), h = null), a.$treeScope.$callbacks.dragStop(n), a.$$allowNodeDrop = !1, u = null;
                    ...
                    angular.element(o).bind("touchend", T), angular.element(o).bind("touchcancel", T), angular.element(o).bind("touchmove", E), angular.element(o).bind("mouseup", T), angular.element(o).bind("mousemove", E), angular.element(o).bind("mouseleave", x)
                }, X = function() {
                    angular.element(o).unbind("touchend", T), angular.element(o).unbind("touchcancel", T), angular.element(o).unbind("touchmove", E), angular.element(o).unbind("mouseup", T), angular.element(o).unbind("mousemove", E), angular.element(o).unbind("mouseleave", x)
                }, Y = function(e) {
                    27 == e.keyCode && (a.$$allowNodeDrop = !1, v(e))
                }, angular.element(t.document).bind("keydown", Y), a.$on("$destroy", function() {
                    angular.element(t.document).unbind("keydown", Y)
                })
            }
        }
    }])
        ...
        return {
            ...
            link: function(n, t, o, l) {
                var r = {},
                    ...
                    i = l[1],
                    d = l[2];
                angular.extend(r, e), r.nodesClass && t.addClass(r.nodesClass), i ? (i.scope.$childNodesScope = n, n.$nodeScope = i.scope) : d.scope.$nodesScope = n, n.$treeScope = d.scope, a && (a.$render = function() {
